...
export class ListComponent {
  ...
  items$: Observable<WholeVideoData[]> = this.youTubeService.item$;
  ...
  // private sortItems() {
  //   this.youTubeService.getItems(this.searchText).subscribe((data: Item[]) => {
  //     this.wholeData = [];
  //     data.forEach((elem) => {
  //       //make request for statictics and put data in one common array
  //       this.youTubeService
  //         .getStatistics(elem.id.videoId)
  ...
  //         });
  //     });
  //     this.items = this.wholeData.sort(
  //       (a: WholeVideoData, b: WholeVideoData) => {
